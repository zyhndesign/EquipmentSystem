						...
						<div class="zyForm">
							...
							<div class="row">
								...
								<div class="zyFormAllInlineCtrl">
									...
									<input class="with-gap" name="infoMarketType" value="1" type="radio" id="type1" checked /> <label for="type1">上市产品</label> <input class="with-gap"
										name="infoMarketType" value="2" type="radio" id="type2" /> <label style="margin-left: 50px" for="type2">概念产品</label>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<label class="zyFormLabel zyRequired">图像：</label> <font class="zyFormHelp">（上传两张不同角度的图像）</font> <br>

								<div class="zyFormChildCtrl">
									<label class="zyFormLabel zyRequired zyFormLabelHasSub">图片1<br>&nbsp;&nbsp;&nbsp;&nbsp;(svg)
									</label>
                            ...
                            <label for="textureChild1">亮光</label>-->
										...
										<div class="row">
											...
											<div class="zyFormAllInlineCtrl">
												...
												<input class="with-gap" name="biaoZhi" value="有" type="radio" id="biaoZhi1" checked /> <label for="biaoZhi1">有</label> <input class="with-gap" name="biaoZhi"
													value="无" type="radio" id="biaoZhi2" /> <label style="margin-left: 50px" for="biaoZhi2">无</label>
											</div>
										</div>
									</div>
				...
				<div class="row zyForm" style="padding: 10px 0px !important; position: relative">
					<div class="col s6">
						<div class="zyBgFFFFFF zyPd10">
							...
							<div class="row">
								<label class="zyFormLabel">模型：</label> <a class="zyFormLabel" target="_blank" id="pInfoModal" href="#"></a>
							</div>
						</div>
