...
<body>
        ...
        <div class="zyPanel">
            <div class="zyPanelTitle" style="height: 40px;line-height: 36px;">
                ...
                <button id="removeBtn" class="btn grey right hide">删除</button>
            ...
            <div class="col s6">
                <div class="row">
                    ...
                    <div style="width: auto;height: 100px;overflow: hidden;display: inline-block">
                        <img src="/images/cut.png" id="cutImage">
                    </div>
                </div>
                <div class="row">
...
<div id="cutImageModal" class="modal zyModal">
    ...
    <div class="modal-content">
        ...
        <div class="zyTabPanel">
            <img id="toCutImage" style="width: 600px" src="/data/product1.svg">
        </div>
    </div>
...
<div id="previewModal" class="modal zyModal">
    ...
    <div class="col s6">
        <div class="zyBgFFFFFF zyPd10">
            ...
            <div class="row">
                <label class="zyFormLabel">模型：</label>
                <a class="zyFormLabel" id="pInfoModal" href="xxxx.fbx">xxxx.fbx</a>
            </div>
        </div>
    ...
    <div class="col s6 zyBgFFFFFF" style="position: absolute;left:50%;top:10px;bottom:10px">
        ...
        <img src="/images/upload.png" id="pImage" class="zyPCenter" style="width: 100%;height: auto">
    </div>
    </div>
<!--
<div class="row">
